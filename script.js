...
function clickEvent() {
  var textMainColor = getComputedStyle(
    document.documentElement
  ).getPropertyValue("--main_text_color");
  var textAltColor = getComputedStyle(
    document.documentElement
  ).getPropertyValue("--main_text_color_alt");
  var theSelected = this.innerText;
  console.log(theSelected);
  switch (theSelected) {
    case "See My Work":
      $(".work_content").css("display", "flex");
      $(".intro_content, .about_me_content, .contact_content").css(
        "display",
        "none"
      );
    ...
    case "About Me":
      ...
      $(".intro_content, .work_content, .contact_content").css(
        "display",
        "none"
      );
    ...
    case "Contact":
      ...
      $(".intro_content, .work_content, .about_me_content").css(
        "display",
        "none"
      );
    ...
    default:
      ...
      $(".work_content, .about_me_content, .contact_content").css(
        "display",
        "none"
      );
...
function formSubmit() {
  ...
  console.log(
    nameBox + " : " + emailBox + " : " + phoneBox + " : " + messageBox
  );
  alert(
    "For testing reasons only, message is not sent. Your inputs were: Name:" +
      nameBox +
      " Email: " +
      emailBox +
      " Phone: " +
